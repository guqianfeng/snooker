package {
	...
	public class mainRenren extends Sprite {
		...
		private function init(event:Event):void {
			...
			*/
			...
			renrenData.name = "郑寒安";
			renrenData.uid = 408239096;
			renrenData.headurl = "http://hdn.xnimg.cn/photos/hdn321/20110909/0200/h_head_7ami_5e6500004c132f76.jpg";
			renrenData.tinyurl = "http://hdn.xnimg.cn/photos/hdn321/20110909/0200/h_tiny_KfJH_5e6500004c132f76.jpg";
			renrenData.sex = 0;
			renrenData.zidou = 0;
		...
		private function acceptInvitation(temp:* = null):void {
			...
			sfs.sendXtMessage("SnookerRoom", "prepareRoom", { opponent:opponentId } );//这里的opponent是
